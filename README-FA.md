...
### 🎨 بهبودهای بصری و تجربه کاربری
- **پشتیبانی از صفحه‌نمایش کوچک** - رفع مشکل ارتفاع در دستگاه‌های صفحه کوچک با فرم قابل اسکرول
- **ردیابی وضعیت بهتر** - آمار Pass/Fail/Found به صورت لحظه‌ای با نمایش رنگی (سفید=پیدا شده، سبز=موفق، قرمز=ناموفق)
- **سرورهای ناموفق در انتها** - تست‌های پروکسی ناموفق اکنون در انتهای لیست نتایج نمایش داده می‌شوند

### 🔐 احراز هویت پروکسی
- **پشتیبانی از احراز هویت پروکسی** - چک‌باکس جدید برای پروکسی‌هایی که نیاز به احراز هویت دارند
- **فیلدهای نام کاربری/رمز عبور** - به صورت پیش‌فرض مخفی، هنگام فعال‌سازی احراز هویت نمایش داده می‌شوند
- **احراز هویت HTTP و SOCKS5** - احراز هویت برای هر دو تست پروکسی HTTP و SOCKS5 اعمال می‌شود

### ⌨️ میانبرهای صفحه‌کلید
- **S** - شروع اسکن (از صفحه تنظیمات)
- **Q** - خروج از برنامه
- **C** - ذخیره نتایج
- **P** - توقف اسکن (هنگام اسکن)
- **R** - ادامه اسکن (وقتی متوقف شده)
- **X** - تصادفی‌سازی IP‌ها (وقتی متوقف شده)

### 🔔 بهبود صدا
- **صدای سکه تکی** - اعلان صدای سکه/درخشش تمیز و تکی هنگام تست موفق پروکسی
...
### 🎨 بهبودهای بصری و تجربه کاربری
- **تم تاریک GitHub** - حالت تاریک زیبا با رنگ‌های سبک GitHub (پس‌زمینه #0d1117، رنگ‌های تاکید #58a6ff)
- **منوی شروع تمام‌صفحه** - فرم پیکربندی اکنون از تمام ارتفاع/عرض ترمینال استفاده می‌کند
- **بهبود منوهای کشویی** - اصلاح استایل منوهای کشویی با ارتفاع مناسب و نمایش متن
- **چک‌باکس‌های فشرده** - همه گزینه‌ها (زیردامنه تصادفی، تست پروکسی، صدای زنگ) در یک ردیف

### ⚡ بهبودهای کارایی
- **۵ تست پروکسی همزمان** - افزایش از ۳ به ۵ تست موازی Slipstream (پورت‌های ۱۰۸۰۰-۱۰۸۰۴)
- **مدیریت بهتر خروج** - بازگردانی مناسب ترمینال هنگام خروج با بازیابی مکان‌نما و ورودی

### 🌍 مدیریت CIDR
- **IP‌های ایران از پیش بارگذاری شده** - حدود ۱۰ میلیون آدرس IPv4 ایران (iran-ipv4.cidrs)
- **منوی کشویی CIDR** - انتخاب آسان بین پیش‌فرض ایران و فایل‌های سفارشی
- **کش دامنه** - به خاطر سپردن آخرین دامنه در بین جلسات

## ✨ ویژگی‌ها

- 🎨 **رابط کاربری TUI زیبا** - رابط ترمینال با تم تاریک GitHub
- ⚡ **کارایی بالا** - اسکن غیرهمزمان با قابلیت تنظیم همزمانی
- ⏸️ **توقف/ادامه/تصادف‌سازی** - کنترل کامل اسکن
...
- 🔌 **یکپارچه‌سازی Slipstream** - تست پروکسی اختیاری با ۵ اجرای موازی
...
- 🔔 **هشدارهای صوتی** - صدای درخشش اختیاری هنگام تست موفق پروکسی
